...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const __$temp_1 = storeToRefs(frontendArticleStore), topics = toRef(__$temp_1, "visit");
    ...
    [__temp, __restore] = withAsyncContext(() => useAsyncData("frontend-index-visit", () => frontendArticleStore.getArticleList(getConfig(), "visit"))), await __temp, __restore();
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/trending/[by].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_by_-CZg7lwAq.mjs.map
