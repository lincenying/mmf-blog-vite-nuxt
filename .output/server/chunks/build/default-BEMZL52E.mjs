...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "frontend" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_global_navigation, { "is-backend": false }, null, _parent));
...
//# sourceMappingURL=default-BEMZL52E.mjs.map
