...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useAsyncData("backend-admin-list", () => backendAdminStore.getAdminList({ page: 1, path: route.fullPath }))), await __temp, __restore();
    const __$temp_1 = storeToRefs(backendAdminStore), lists = toRef(__$temp_1, "lists");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "card settings-main" }, _attrs))}><div class="settings-main-content"><div class="list-section list-header"><div class="list-username">\u7528\u6237\u540D</div><div class="list-email">\u90AE\u7BB1</div><div class="list-date">\u65F6\u95F4</div><div class="list-action">\u64CD\u4F5C</div></div><!--[-->`);
      ssrRenderList(lists.value.data, (item) => {
        ...
        _push(ssrRenderComponent(_component_router_link, {
          to: `/_backend/admin/modify?id=${item._id}`,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/_backend/admin/list.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=list-k9m7pA6I.mjs.map
