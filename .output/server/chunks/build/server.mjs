...
import { hasInjectionContext, inject, onScopeDispose, version, ref, watchEffect, watch, getCurrentInstance, toRaw, isRef, isReactive, toRef, defineComponent, provide, createElementBlock, h, computed, unref, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, mergeProps, withCtx, createVNode, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, defineAsyncComponent, shallowRef, isReadonly, toRefs, markRaw, isShallow } from 'vue';
...
const VueMarkdownEditor = /*@__PURE__*/getDefaultExportFromCjs(baseEditorExports);
...
function getNuxtAppCtx(appName2 = appId) {
  return getContext(appName2, {
    asyncContext: false
  });
}
...
function tryUseNuxtApp(appName2) {
  var _a;
  let nuxtAppInstance;
  if (hasInjectionContext()) {
    nuxtAppInstance = (_a = getCurrentInstance()) == null ? void 0 : _a.appContext.app.$nuxt;
  }
  nuxtAppInstance = nuxtAppInstance || getNuxtAppCtx(appName2).tryUse();
  return nuxtAppInstance || null;
}
function useNuxtApp(appName2) {
  const nuxtAppInstance = tryUseNuxtApp(appName2);
  if (!nuxtAppInstance) {
    {
...
const unhead_O9B5b2LBEY = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    redirect: "/_backend/login",
    component: () => import('./_backend-B-R8zFYI.mjs').then((m) => m.default || m),
    children: [
      {
        name: "_backend-admin-list",
        path: "admin/list",
        meta: __nuxt_page_meta$i || {},
        component: () => import('./list-k9m7pA6I.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-admin-modify",
        path: "admin/modify",
        meta: __nuxt_page_meta$h || {},
        component: () => import('./modify-Cw0_rKtS.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-article-comment",
        path: "article/comment",
        meta: __nuxt_page_meta$g || {},
        component: () => import('./comment-r0IrXfch.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-article-insert",
        path: "article/insert",
        meta: __nuxt_page_meta$f || {},
        component: () => import('./insert-DO9rfr6Z.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-article-list",
        path: "article/list",
        meta: __nuxt_page_meta$e || {},
        component: () => import('./list-DtU-2nUk.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-article-modify",
        path: "article/modify",
        meta: __nuxt_page_meta$d || {},
        component: () => import('./modify-D8jJpn8M.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-category-insert",
        path: "category/insert",
        meta: __nuxt_page_meta$c || {},
        component: () => import('./insert-BxqE7klJ.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-category-list",
        path: "category/list",
        meta: __nuxt_page_meta$b || {},
        component: () => import('./list-B20G2isO.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-category-modify",
        path: "category/modify",
        meta: __nuxt_page_meta$a || {},
        component: () => import('./modify-CqhA7gYR.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-login",
        path: "login",
        component: () => import('./login-up7gvvth.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-user-list",
        path: "user/list",
        meta: __nuxt_page_meta$9 || {},
        component: () => import('./list-62x3dT7q.mjs').then((m) => m.default || m)
      },
      {
        name: "_backend-user-modify",
        path: "user/modify",
        meta: __nuxt_page_meta$8 || {},
        component: () => import('./modify-BxPBaCCu.mjs').then((m) => m.default || m)
      }
    ]
  },
  {
    name: "all",
    path: "/:all(.*)*",
    component: () => import('./_...all_-BwuyTPjS.mjs').then((m) => m.default || m)
  },
  {
    name: "about",
    path: "/about",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./about-DQ75nbGG.mjs').then((m) => m.default || m)
  },
  {
    name: "article-id",
    path: "/article/:id()",
    component: () => import('./_id_-CxWu4W15.mjs').then((m) => m.default || m)
  },
  {
    name: "category-id",
    path: "/category/:id()",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./_id_-BYXOJeBy.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./index-D2Nhdrtn.mjs').then((m) => m.default || m)
  },
  {
    name: "search-key",
    path: "/search/:key()",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./_key_-B3CjOog4.mjs').then((m) => m.default || m)
  },
  {
    name: "trending-by",
    path: "/trending/:by()",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./_by_-CZg7lwAq.mjs').then((m) => m.default || m)
  },
  {
    name: "user",
    path: "/user",
    component: () => import('./user-D6rE03FM.mjs').then((m) => m.default || m),
    children: [
      {
        name: "user-account",
        path: "account",
        meta: __nuxt_page_meta$1 || {},
        component: () => import('./account-DO8rgk8K.mjs').then((m) => m.default || m)
      },
      {
        name: "user-password",
        path: "password",
        meta: __nuxt_page_meta || {},
        component: () => import('./password-DbsYl4xv.mjs').then((m) => m.default || m)
      }
    ]
  }
];
...
const namedMiddleware = {
  "backend-auth": () => import('./backend-auth-BDPQIhPS.mjs'),
  "frontend-auth": () => import('./frontend-auth-Cm544JWm.mjs')
};
...
const revive_payload_server_OB1qANS4nw = /* @__PURE__ */ defineNuxtPlugin({
...
const md_editor_Z6CsSVbYGe = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(VueMarkdownEditor);
});
const plugins = [
  unhead_O9B5b2LBEY,
  plugin$1,
  revive_payload_server_OB1qANS4nw,
  plugin,
...
const layouts = {
  backend: () => import('./backend-DQ4qjiWi.mjs').then((m) => m.default || m),
  default: () => import('./default-BEMZL52E.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-F2RckUGn.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Bp1jLx8x.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.12.3_@parcel+watcher@2.4.1_@types+node@20.14.11_encoding@0.1.13_eslint@9.7.0_ioredis@5_76lr7xq7iht327drtk7b7yn7py/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.12.3_@parcel+watcher@2.4.1_@types+node@20.14.11_encoding@0.1.13_eslint@9.7.0_ioredis@5_76lr7xq7iht327drtk7b7yn7py/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { __nuxt_component_0 as _, useHead as a, useRouter as b, __nuxt_component_4 as c, defineStore as d, commonjsGlobal as e, useState as f, defineNuxtRouteMiddleware as g, useNuxtApp as h, asyncDataDefaults as i, createError as j, fetchDefaults as k, nuxtLinkDefaults as l, resolveRouteObject as m, navigateTo as n, onBeforeRouteLeave as o, useRuntimeConfig as p, server as q, require$$0 as r, storeToRefs as s, useRoute as u };
