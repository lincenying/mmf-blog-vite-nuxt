...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"M.M.F小屋"},{"name":"apple-mobile-web-app-status-bar-style","content":"black-translucent"}],"link":[{"rel":"icon","href":"/favicon.ico","sizes":"any"},{"rel":"apple-touch-icon","href":"/static/img/icons/apple-touch-icon-180x180.png"}],"style":[],"script":[],"noscript":[],"viewport":"width=device-width,initial-scale=1"};
